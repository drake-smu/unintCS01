...
####<font size="3">
Colorado has the most alcoholic beer of any state! Lee Hill Series Vol. 5,  
a Belgian Style Quadrupel Ale produced in Boulder,CO has an ABV of 12.8%.  
We also see that Kentucky and Washington DC prefer the most  
alcoholic beers overall, while in general, the states prefer beer with an  
average alcoholic content, giving the distribution a tight, somewhat  
normal shape.
</font>
...
```
####<font size="3">
Oregon has the bitterest beer of any state!  
Bitter Bitch Imperial IPA, produced in Astoria,  
has an IBU of 138! We also see that overall, Maine   
has the bitterest beers. It seems that most states  
prefer beer which is less bitter than average,  
...
=======
hchart(BeerBrew, "scatter", hcaes(x='ABV',  y='IBU', group ='Style')) %>%
>>>>>>> Stashed changes
...
=======
hchart(styledf, "treemap", hcaes(x = 'Style', value = 'n', color = 'n'))
>>>>>>> Stashed changes
```
